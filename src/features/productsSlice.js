...
export const FETCH_DATA_REQUEST = createAsyncThunk(
  "products/fetchDataRequest",
  async () => {
...
export const ADD_PRODUCT_REQUEST = createAsyncThunk(
...
export const DELETE_PRODUCT_REQUEST = createAsyncThunk(
...
export const UPDATE_PRODUCT_REQUEST = createAsyncThunk(
